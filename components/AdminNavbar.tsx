...
export default function AdminNavbar(): JSX.Element {
    const dropdownItem = `flex p-2 font-medium text-gray-600 rounded-md hover:bg-gray-100 hover:text-black`
                    ...
                    <li className="relative">
                        ...
                        <div className={`right-0 p-2 mt-1 bg-white rounded-md shadow-xl lg:absolute ${isDropdownOpen ? 'flex flex-col' : 'hidden'}`}>
                            <ul className="space-y-2 lg:w-48">
                                <li><Link href="/"><p className={dropdownItem}>Home</p></Link></li>
                                <li><Link href="#"><p className={dropdownItem}>Logout</p></Link></li>
                            </ul>
                        </div>
                        {/* <!-- dropdown menu --> */}
                    </li>
